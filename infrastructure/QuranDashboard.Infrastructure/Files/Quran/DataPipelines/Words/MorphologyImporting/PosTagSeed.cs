...
public static class PosTagSeed
{
    ...
    [
        ...
        new PosTag { Code = "CAUS", ArabicLabel = "فاء السببية", EnglishLabel = "Causative", Category = "particle", SortOrder = 25, Description = "Causal fā (فاء السببية); appears as a prefix" },
