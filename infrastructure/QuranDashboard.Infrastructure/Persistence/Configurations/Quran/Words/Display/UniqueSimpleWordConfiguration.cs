...
public sealed class UniqueSimpleWordConfiguration : IEntityTypeConfiguration<UniqueSimpleWord>
{
    public void Configure(EntityTypeBuilder<UniqueSimpleWord> builder)
    {
        builder.ToTable("quran_words_unique_simple");
