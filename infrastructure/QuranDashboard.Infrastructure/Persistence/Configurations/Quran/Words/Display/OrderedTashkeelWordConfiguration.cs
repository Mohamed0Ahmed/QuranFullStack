...
public sealed class OrderedTashkeelWordConfiguration : IEntityTypeConfiguration<OrderedTashkeelWord>
{
    public void Configure(EntityTypeBuilder<OrderedTashkeelWord> builder)
    {
        builder.ToTable("quran_words_ordered_tashkeel");
