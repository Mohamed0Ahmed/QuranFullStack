...
- Confirmation that the nearest README was updated when its described behavior, commands, boundaries, data invariants, API/URL contracts, or test rules changed.
