...
- Open: `ux-slice-c` — `docs/feature-ux-slice-c/plan.md` (plan + decision record; this
  feature does not populate `specs/`, following `abwab-doors`, `abwab-global-order`,
  `abwab-relations`, and `abwab-templates`).
