...
// Per-instance id: a frameless copy can mount beside the inert background panel, so a static id would
// duplicate and break aria-controls / aria-labelledby resolution.
