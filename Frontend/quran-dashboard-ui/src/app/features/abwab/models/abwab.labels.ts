...
export const ABWAB_LABELS = {
  ...
  doorLinksSelectPage: 'تحديد الصفحة',
  ...
  doorLinksExpandRecord: (position: number): string => `عرض تفاصيل سجل الربط ${position}`,
  doorLinksCollapseRecord: (position: number): string => `إخفاء تفاصيل سجل الربط ${position}`,
  doorLinksLoading: 'جارٍ تحميل روابط الباب…',
  doorLinksAyahsLoading: 'جارٍ تحميل آيات الرابط…',
  doorLinksEmpty: 'لا توجد روابط لهذا الباب.',
  doorLinksAyahsEmpty: 'لا توجد آيات في سجل الربط.',
  doorLinksLoadMore: 'تحميل المزيد من الروابط',
  doorLinksLoadMoreAyahs: 'تحميل المزيد من الآيات',
  ...
  doorLinksCopyScope: 'اختر الروابط',
  doorLinksCopyAllScope: (count: number): string => `كل روابط الباب (${count})`,
  doorLinksCopySelectedScope: (count: number): string => `الروابط المحددة (${count})`,
  ...
  doorLinksCopyPreparing: 'جارٍ تحضير آيات دفعة النسخ الحالية…',
  doorLinksCopyRunning: 'دفعة النسخ مفتوحة للمراجعة.',
  doorLinksCopyBatch: (batch: number, total: number): string => `الدفعة ${batch} من ${total}`,
  ...
  doorLinksCopyBatchInvalid: 'تعذر تحضير دفعة النسخ ضمن الحد المسموح.',
  doorLinksCopyStartError: 'تعذر بدء دفعة النسخ.',
