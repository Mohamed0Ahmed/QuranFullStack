...
export const ABWAB_CONFLICT_MESSAGES: Record<AbwabConflictCode, string> = {
  ...
  'abwab.template_cycle': 'لا يمكن نقل العقدة إلى نفسها أو إلى أحد فروعها داخل القالب.',
  'abwab.template_revision_stale': 'تغيّر القالب أثناء التعديل. يرجى إعادة المحاولة.',
