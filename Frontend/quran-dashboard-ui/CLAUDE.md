...
| Select, run, or report Frontend tests | Read `TESTING_CONSTITUTION.md`, then `Frontend/quran-dashboard-ui/testing/README.md`. |
| Write or review Frontend tests | Apply that testing constitution, then read `.claude/skills/test-guard/SKILL.md` and `references/jest.md`. |
