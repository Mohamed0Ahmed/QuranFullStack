# Abwab API — Sections, Categories, Tree, Protection (`029`)

**Layer:** Api · **Feature:** `029-abwab-core` · **HOW rules:** `Backend/.architecture/API_GUIDELINES.md`
...
`abwab.tree_revision_stale`, `abwab.timeline_generation_stale`, `abwab.row_stale`, …). Never
