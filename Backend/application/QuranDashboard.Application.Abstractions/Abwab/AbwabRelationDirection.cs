...
// AbwabDoorRelation.BroaderDoorId. Anchor-relative on purpose — the design contract
// (docs/design-preview/abwab-relations-concept.html) uses "broader"/"narrower" from two different
// perspectives in two places, so neither token may reach the wire (plan §5.3).
