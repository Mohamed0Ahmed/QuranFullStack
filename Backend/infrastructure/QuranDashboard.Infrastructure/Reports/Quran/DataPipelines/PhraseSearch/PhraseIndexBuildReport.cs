...
internal sealed record PhraseIndexBuildReport(
    ...
    string Outcome,
    bool Forced,
    [property: JsonIgnore(Condition = JsonIgnoreCondition.Never)] bool? Persisted,
    bool? Active,
    [property: JsonIgnore(Condition = JsonIgnoreCondition.Never)] bool? ExactReady,
    [property: JsonIgnore(Condition = JsonIgnoreCondition.Never)] bool? SimilarityReady,
