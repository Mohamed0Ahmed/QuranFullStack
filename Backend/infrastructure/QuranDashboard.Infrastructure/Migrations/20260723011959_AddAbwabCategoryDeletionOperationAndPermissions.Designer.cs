...
namespace QuranDashboard.Infrastructure.Migrations
{
    ...
    [Migration("20260723011959_AddAbwabCategoryDeletionOperationAndPermissions")]
    partial class AddAbwabCategoryDeletionOperationAndPermissions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuranDashboard.Domain.Abwab.Audit.AuditEvent", b =>
                {
                    ...
                    b.HasIndex("ChangeSetId", "EventOrdinal")
                        .IsUnique();

                    b.ToTable("abwab_audit_events", (string)null);
                });

            modelBuilder.Entity("QuranDashboard.Domain.Abwab.Audit.ChangeSet", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<long>("ChangeSetSequence")
                    ...
                    b.Property<long>("TimelineGeneration")
                        .HasColumnType("bigint")
                        .HasColumnName("timeline_generation");

                    b.HasKey("Id");

                    b.HasIndex("ChangeSetSequence")
                        .IsUnique();

                    b.ToTable("abwab_change_sets", (string)null);
                });

            modelBuilder.Entity("QuranDashboard.Domain.Abwab.Categories.Category", b =>
                {
                    b.Property<Guid>("CategoryId")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.PrimitiveCollection<List<Guid>>("AncestorIds")
                        .IsRequired()
                        .HasColumnType("uuid[]")
                        .HasColumnName("ancestor_ids");

                    b.Property<long>("CategoryContentRevision")
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("OrdinaryProtectionActorSubject")
                        .HasColumnType("text")
                        .HasColumnName("ordinary_protection_actor_subject");

                    b.Property<DateTimeOffset?>("OrdinaryProtectionLastEditedAtUtc")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.ToTable("abwab_categories", (string)null);
                });

            modelBuilder.Entity("QuranDashboard.Domain.Abwab.Categories.CategorySearchAlias", b =>
                {
                    b.Property<Guid>("CategorySearchAliasId")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("CategorySearchAliasId");

                    b.HasIndex("CategoryId", "NormalizedValue")
                        .IsUnique()
                        .HasDatabaseName("ix_abwab_category_search_aliases_active")
                        .HasFilter("is_deleted = false");

                    b.ToTable("abwab_category_search_aliases", (string)null);
                });

            modelBuilder.Entity("QuranDashboard.Domain.Abwab.Concurrency.AbwabWriteBarrier", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
                    ...
                    b.ToTable("abwab_write_barrier", null, t =>
                        {
                            t.HasCheckConstraint("ck_abwab_write_barrier_singleton", "id = 1");
                        });
            ...
            modelBuilder.Entity("QuranDashboard.Domain.Abwab.Notifications.NotificationReadState", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("RecipientSubject")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("recipient_subject");

                    b.HasKey("Id");

                    b.HasIndex("NotificationId", "RecipientSubject")
                        .IsUnique();

                    b.ToTable("abwab_notification_read_states", (string)null);
                });

            modelBuilder.Entity("QuranDashboard.Domain.Abwab.Notifications.NotificationRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("RecipientSubject");

                    b.HasIndex("SourceIdentity")
                        .IsUnique();

                    b.ToTable("abwab_notification_records", (string)null);
                });

            modelBuilder.Entity("QuranDashboard.Domain.Abwab.Protection.ManualProtection", b =>
                {
                    b.Property<Guid>("ManualProtectionId")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("AppliedByActorSubject")
                        .IsRequired()
                        .HasColumnType("text")
                    ...
                    b.Property<string>("LiftedByActorSubject")
                        .HasColumnType("text")
                        .HasColumnName("lifted_by_actor_subject");

                    b.Property<int>("ProtectionScope")
                        .HasColumnType("integer")
                    ...
                    b.HasKey("ManualProtectionId");

                    b.HasIndex("CategoryId", "ProtectionType")
                        .IsUnique()
            ...
            modelBuilder.Entity("QuranDashboard.Domain.Abwab.Sections.Section", b =>
                {
                    ...
                    b.Property<bool>("IsPermanentDefault")
                        .HasColumnType("boolean")
                    ...
                    b.HasData(
                        new
                        {
                            SectionId = new Guid("00000000-0000-0000-0000-000000000001"),
                            IsDeleted = false,
                            IsPermanentDefault = true,
                            Name = "أبواب غير مصنفة",
                            NormalizedName = "ابواب غير مصنفة",
                            SortOrder = 0,
                            Version = 0u
                        });
                });
            ...
            modelBuilder.Entity("QuranDashboard.Domain.Abwab.Timeline.AbwabRevisionState", b =>
                {
                    ...
                    b.Property<long>("AuditHeadSequence")
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("TreeRevision")
                        .HasColumnType("bigint")
                        .HasColumnName("tree_revision");

                    b.HasKey("Id");

                    b.ToTable("abwab_revision_state", null, t =>
                        {
                            t.HasCheckConstraint("ck_abwab_revision_state_singleton", "id = 1");
                        });
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AuditHeadSequence = 0L,
                            TimelineGeneration = 0L,
                            TreeRevision = 0L
                        });
                });

            modelBuilder.Entity("QuranDashboard.Domain.Abwab.Timeline.TimelineGenerationBoundary", b =>
                {
                    ...
                    b.ToTable("abwab_timeline_generation_boundaries", (string)null);

                    b.HasData(
                        new
                        {
                            Generation = 0L,
                            CreatedAtUtc = new DateTimeOffset(new DateTime(2026, 7, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsRoot = true,
                            Reason = "genesis"
                        });
                });
            ...
            modelBuilder.Entity("QuranDashboard.Domain.Abwab.Categories.Category", b =>
                {
                    ...
                    b.HasOne("QuranDashboard.Domain.Abwab.Sections.Section", null)
                        .WithMany()
            ...
            modelBuilder.Entity("QuranDashboard.Domain.Abwab.Notifications.NotificationReadState", b =>
                {
                    b.HasOne("QuranDashboard.Domain.Abwab.Notifications.NotificationRecord", null)
                        .WithMany()
