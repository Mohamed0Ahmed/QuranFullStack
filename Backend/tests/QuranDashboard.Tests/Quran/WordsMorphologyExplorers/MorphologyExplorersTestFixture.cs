...
public sealed class MorphologyExplorersTestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        databaseLease =
            ExternalReadOnlyDatabaseOptIn.TryLease(ExternalReadOnlyDatabaseOptIn.MorphologyExplorersConnectionVariable)
            ?? await PostgreSqlTestProcess.LeaseMigratedDatabaseAsync(nameof(MorphologyExplorersTestFixture));
