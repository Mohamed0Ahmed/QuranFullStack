...
// Separate from SmokeCollection, not merely a separate fixture: SmokeRoutePipelineTests derives its
// expectations from a migrated-but-empty schema, and an xUnit collection is what guarantees the
