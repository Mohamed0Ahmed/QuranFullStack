...
import { mushafSurahIconLigature, mushafSurahNameLigature } from './mushaf-surah-name-ligature';
...
describe('mushafSurahIconLigature', () => {
  it('maps the surah icon ligature key', () => {
    expect(mushafSurahIconLigature()).toBe('surah');
  });
});
